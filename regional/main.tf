...
module "cloud_nat" {
  source = "github.com/osinfra-io/terraform-google-network//regional/nat?ref=v0.2.3"
...
module "subnets" {
  source = "github.com/osinfra-io/terraform-google-network//regional?ref=v0.2.2"
