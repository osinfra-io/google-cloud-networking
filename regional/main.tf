...
module "cloud_nat" {
  source = "github.com/osinfra-io/terraform-google-network//regional/nat?ref=initial-development"
...
module "subnets" {
  source = "github.com/osinfra-io/terraform-google-network//regional?ref=initial-development"
