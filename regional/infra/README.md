...
| <a name="input_workspace_environment"></a> [workspace\_environment](#input\_workspace\_environment) | The workspace environment suffix for example: `sandbox`, `non-production`, `production` | `string` | `"sandbox"` | no |
